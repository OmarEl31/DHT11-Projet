        ...
        if serial.is_valid():
            ...
            if serial.is_valid():
                ...
                if derniere_temperature > 20:
                    ...
                    recipient_list = ['aymanoaymanouf25@gmail.com']
                    send_mail(subject, message, email_from, recipient_list)

                    # Alert WhatsApp
                    account_sid = 'AC4653a9dbaabf99a8db62797b01b41cf6'
                    auth_token = '9f8fbe4efe61171388733f19385e835f'
                    client = Client(account_sid, auth_token)

                    message = client.messages.create(
                        from_='whatsapp:+14155238886',
                        body='La temperature a depasser 25',
                        to='whatsapp:+212607907449'
                    )

                    print(message.sid)

                    # Alert Telegram
                    telegram_token = '7424098696:AAHOy-5Sq-Ym-KQNPIN5rFxAShaO92SR3tE'
                    chat_id = '1690639176'  # Remplacez par votre ID de chat
